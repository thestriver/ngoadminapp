            ...
            <div class="w-full flex flex-wrap">
                ...
                <div class="w-full md:w-1/2 flex flex-col">
                    ...
                    <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                        <p class="text-center text-3xl text-green-500">Welcome Back.</p>
                        <p class="text-center  text-green-500">Please fill in your email and password</p>
                        ...
                        <form class="flex flex-col pt-3 md:pt-8">
                            ...
                            <input type="submit" value="Log In" class="bg-green-500 text-white font-bold text-lg hover:bg-gray-700 p-3 mt-8" />
                        </form>
                        <div class="text-center pt-12 pb-12 cursor-pointer">
                            <p class="underline text-green-500 font-semibold"> Don't have an account? Sign Up here.</p>
                        </div>
                    </div>
