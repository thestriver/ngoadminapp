...
<div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
    ...
    <div class="container mx-auto xl:px-12 xl:py-4">
        ...
        <div class="flex xl:px-8">
            ...
            <div class=" text-gray-900 text-2xl mr-40">To-Do List</div>
        ...
        {/* Forms */}
        {/* <!-- component --> */}
            <div class=" rounded px-8 pt-2 pb-8 flex flex-col my-32 items-center content-center center text-center">
            <div class="-mx-3 md:flex mb-2 ">
                
                <div className='list-wrapper bg-white rounded shadow py-20 px-40 w-full'>
                <h1 className='card-header-title header text-grey-darkest text-3xl'>
