...
class TableVolunteer extends Component {
    render() {
                            ...
                            <div id="Table" class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                                <table class="min-w-full leading-normal">
                                    ...
                                    {items.map((item) => {
                                        return (
                                        <tr>
                                            <td  key={item.idnumber} class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{item.idnumber}</p>
                                            </td>
                                            <td key={item.fullname}  class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{item.fullname}</p>
                                            </td>
                                            <td key={item.phonenumber} class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap"> {item.phonenumber}</p>
                                            </td>
                                            <td key={item.email} class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{item.email}</p>
                                            </td>
                                            <td key={item.availability} class="px-5 py-5 border-b border-gray-200  bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap text-center">{item.availability}</p>
                                            </td>
                                            <td key={item.team} class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <p class="text-gray-900 whitespace-no-wrap">{item.team}</p>
                                            </td>
