    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <div class="text-center">
                <h2 class="text-gray-700 text-2xl">Add Volunteer</h2>
            </div>
                    ...
                    <div class="p-6  rounded-md shadow-md">
                        ...
                        <form>
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                                ...
                                <div>
                                    <input class="shadow appearance-none border rounded w-full py-4 px-4  text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline focus:border-green-600" type="number" placeholder="Availability (Weekly)" />
                                </div>

                                <div>
                                    <input class="shadow appearance-none border rounded w-full py-4 px-4  text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline focus:border-green-900" type="text" placeholder="Team" />
                                </div>
