    ...
    <div class=" rounded px-8 pt-2 pb-8 flex flex-col my-2">
        <div class="-mx-3 md:flex mb-2">
            ...
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 focus:border-green-500" id="name" type="text" placeholder="NAME" />
            </div>
                        ...
                        <div class="flex flex-wrap -mx-6">
                            <div class="w-full px-2 sm:w-1/2 xl:w-1/4">
                                <div class="flex items-center px-8 py-6 shadow-sm rounded-md bg-white">
                                    ...
                                    <div class="mx-5">
                                        <div class="text-gray-500">PROJECT MILESTONE I</div>
                            ...
                            <div class="w-full mt-6 px-2 sm:w-1/2 xl:w-1/4 xl:mt-0">
                                ...
                                <div class=" text-right">
                                    <input type="submit" value="Save Project Details" class="bg-green-600 text-white font-bold text-lg rounded-sm hover:bg-gray-700 p-4 " /> 
                                </div>
                            </div>
